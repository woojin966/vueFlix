<template>
  <div class="body_wrap">
    ...
    <Header ref="headerRef" @update:keyword="keyword = $event"  v-model:keyword="keyword"></Header>
    <SearchResults v-if="keyword" :keyword="keyword" />
    <!-- Header에서 받아 할당한 keyword를 MoveList로 props보냄 -->
    <MoveList v-else :keyword="keyword" @notify="handleNotify"></MoveList>
    <Footer></Footer>
  </div>
</template>
